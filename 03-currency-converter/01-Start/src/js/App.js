...
class App extends React.Component {
  ...
  onChangeHandler(e, currency) {
    ...
    if(currency === 'A'){
      ...
      this.setState({
        currencyAval: newValueB / currencyBval.sellRate,
          ...
          <div className="row">
            <div className="col-sm-6 currency-from-input">
              ...
              <div className="input-group">
                <span className="input-group-addon">{currencyA.name}</span>
            ...
            <div className="col-sm-6 currency-to-input">
              <h3 className={`currency-flag ${currencyB.code}`}>{currencyA.name}</h3>
              {
                  //Currency B input
              }
              <div className="input-group">
